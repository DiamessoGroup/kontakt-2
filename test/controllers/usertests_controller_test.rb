...
class UsertestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usertest" do
    assert_difference('Usertest.count') do
      post usertests_url, params: { usertest: { name: @usertest.name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update usertest" do
    patch usertest_url(@usertest), params: { usertest: { name: @usertest.name, password: 'secret', password_confirmation: 'secret' } }
